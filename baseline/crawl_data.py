...
# Fetching data of the city every hour on the data, and data of a day
...
# According to the site id for weather, including history, and predict the same day

data = {
    "history": {
        "days": {
            [{
                "observations": [{}, {}],  # 一天每小时的天气情况 #The weather will be like an hour a day
                "summary": {}  # 一天整体的天气 One day the whole of the weather
            }]
        },
        "end_date": {},
        "start_date": {},
    ...
    "response": {
        "date": {}  # 查询当天的天气情况 Query the day's weather conditions
    }
}
